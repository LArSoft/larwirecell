...
set(_fwc_transitive_deps_Util Boost::date_time Boost::exception Boost::filesystem Boost::iostreams Eigen3::Eigen jsoncpp_lib jsonnet_lib spdlog::spdlog ${CMAKE_DL_LIBS})
  ...
  if (WireCell_FOUND OR (WireCell_LIBRARIES AND WireCell_INCLUDE_DIR))
    ...
    foreach (_fwc_dep IN LISTS _fwc_deps)
      ...
      if (NOT ${_fwc_dep}_FOUND)
        string(JOIN " " _missing_dep ${_fwc_dep} ${_fwc_fp_${_fwc_dep}_args})
        list(APPEND _fwc_missing_deps "${_missing_dep}")
      endif()
    endforeach()
